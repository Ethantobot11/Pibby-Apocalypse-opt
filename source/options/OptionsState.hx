...
{
	var options:Array<String> = ['Pibby Apocalypse', 'Note Colors', 'Controls', 'Adjust Delay and Combo', 'Graphics', 'Visuals and UI', 'Gameplay'];
	...
	override function update(elapsed:Float) {
	 ...
	 if (TouchPad.buttonX.justPressed)
		...
		if (controls.BACK) {
			...
			MusicBeatState.switchState(PauseSubState.options ? new PlayState() : new MainMenuState());
		}
